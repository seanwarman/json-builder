...
const sanitiseMultiTypeChildValues = child => (
  {
    ...child,
...
const sanitiseMultiChildren = jsonForm => (
...
const sanitiseValues = jsonForm => (
  sanitiseJsonValues(sanitiseMultiChildren(jsonForm))
)

const jsonFormSanitiser = jsonForm => (
  sanitiseJson(sanitiseMultiChildren(jsonForm))
)

module.exports = {
  jsonFormSanitiser,
  sanitiseMultiChildren,
  sanitiseMultiTypeChildValues,
  sanitiseJson,
  sanitiseString,
  sanitiseValues
};